...
import {
  ...
  steps,
  type FormValues,
} from "./investorVerification/schema";
import { nigerianBanks } from "./investorVerification/constants";
import { BioDataStep } from "./investorVerification/steps/BioDataStep";
import { NextOfKinStep } from "./investorVerification/steps/NextOfKinStep";
import { AccountDetailsStep } from "./investorVerification/steps/AccountDetailsStep";
import { KYCDocumentsStep } from "./investorVerification/steps/KYCDocumentsStep";
...
export function InvestorVerificationPage() {
  ...
  return (
    <OnboardingLayout
      ...
      pageDescription="Please complete all details to verify your account and start investing"
    >
      <PageTransition>
        <FadeIn>
